...
import img from "../../Images/Woods.png";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 bg-slate-300/5 border border-yellow-400 p-6 sm:p-8 rounded-2xl">
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
              Warm, Woody, Spicy, Luxurious, and slightly sweet - elegant and sensual, suitable for evening or formal wear.
            </p>
          </div>
          ...
          >
            {[
              { title: "Top", text: "Rosewood, Cardamom, Sichuan Pepper" },
              { title: "Middle", text: "Oud (Agarwood), Sandalwood, Vetiver" },
              { title: "Base", text: "Tonka Bean, Vanilla, Amber" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg mb-6">
              Commanding, opulent, and timeless — a scent that speaks of quiet power and regal sophistication. Exotic oud, smoky woods, and warm spices blend into a smooth, velvety aura of confidence. It’s the fragrance of legacy — where tradition meets modern luxury.
            </p>
          </div>
      ...
      <footer className="bg-black/80 border-t border-yellow-400/5 py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-12 text-center">
          <h4 className="text-lg sm:text-xl text-gray-300 mb-4">
            Experience Wood Of Kings
          </h4>
          <p className="text-gray-400 max-w-2xl mx-auto mb-8 text-sm sm:text-base">
            Want to try Wood Of Kings? Reach out from the contact page or visit our collection.
          </p>
