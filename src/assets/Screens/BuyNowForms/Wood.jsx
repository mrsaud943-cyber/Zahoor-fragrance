...
import perfumeImg from "../../Images/Woods.png";
...
const Wood = () => {
    ...
    const handleSubmit = () => {
        ...
        const whatsappMessage = `🛍 Mr.Zaryab Qaiser Awan! I Would Like To Place An Order For "Wood Of Kings". 🛍
            ...
            <div className="w-full max-w-6xl flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16">
                ...
                <form className="md:w-1/2 w-full bg-linear-to-b from-yellow-400/10 to-black/40 backdrop-blur-md rounded-3xl p-6 sm:p-8 border border-yellow-400 shadow-[0_0_20px_rgba(255,255,0,0.1)]">
                    ...
                    <h2 className="text-center text-yellow-300 mb-8 text-xl font-semibold">
                        Wood Of Kings — 50ml <span className="text-yellow-400">Rs 2,599 PKR</span>
                    </h2>
